...
$email = $_POST['email'];
$numTel = $_POST['numTel'];
$ID_Alloggio = $_POST['alloggio'];
$dataInizio = $_POST['checkin'];
$dataFine = $_POST['checkout'];
$stanza = $_POST['stanza'];
...
$query3 = "INSERT INTO prenotazionialloggi(ID_Alloggio, dataInizio, dataFine, stanza, ID_Utente)
